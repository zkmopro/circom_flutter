...
import 'third_party/circom_prover_bindings.dart';
...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1346836277;
...
abstract class RustLibApi extends BaseApi {
  Future<CircomProof> circomProverBindingsCircomProofDefault();

  Future<CircomProofResult> circomProverBindingsCircomProve({
    required String graphPath,
    required String inputs,
    required String zkeyPath,
  });

  Future<bool> circomProverBindingsCircomVerify({
    required CircomProofResult proof,
    required String zkeyPath,
  });

  Future<G1> circomProverBindingsG1Default();

  Future<G2> circomProverBindingsG2Default();

  Future<CircomProofResult> circomProverBindingsGenerateCircomProof({
    required String zkeyPath,
    required String circuitInputs,
    required ProofLib proofLib,
  });

  Future<Halo2ProofResult> circomProverBindingsGenerateHalo2Proof({
    required String srsPath,
    required String pkPath,
    required Map<String, List<String>> circuitInputs,
  });

  Future<Uint8List> circomProverBindingsGenerateNoirProof({
  ...
  Future<Uint8List> circomProverBindingsGetNoirVerificationKey({
    required String circuitPath,
    String? srsPath,
    required bool onChain,
    required bool lowMemoryMode,
  ...
  Future<Halo2ProofResult> circomProverBindingsHalo2ProofResultDefault();

  Future<void> circomProverBindingsInitApp();

  Future<String> circomProverBindingsMoproHelloWorld();

  Future<String> circomProverBindingsMoproWasmHelloWorld();

  Future<ProofLib> circomProverBindingsProofLibDefault();

  Future<bool> circomProverBindingsVerifyCircomProof({
    required String zkeyPath,
    required CircomProofResult proofResult,
    required ProofLib proofLib,
  });

  Future<bool> circomProverBindingsVerifyHalo2Proof({
    required String srsPath,
  ...
  Future<bool> circomProverBindingsVerifyNoirProof({
    required String circuitPath,
    required List<int> proof,
    required bool onChain,
    required List<int> vk,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<CircomProof> circomProverBindingsCircomProofDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsCircomProofDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsCircomProofDefaultConstMeta =>
  ...
  Future<CircomProofResult> circomProverBindingsCircomProve({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(graphPath, serializer);
          sse_encode_String(inputs, serializer);
        ...
        constMeta: kCircomProverBindingsCircomProveConstMeta,
        argValues: [graphPath, inputs, zkeyPath],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCircomProverBindingsCircomProveConstMeta =>
      const TaskConstMeta(
        debugName: "circom_prove",
        argNames: ["graphPath", "inputs", "zkeyPath"],
      );
  ...
  Future<bool> circomProverBindingsCircomVerify({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_circom_proof_result(proof, serializer);
          sse_encode_String(zkeyPath, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
        ...
        constMeta: kCircomProverBindingsCircomVerifyConstMeta,
        argValues: [proof, zkeyPath],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCircomProverBindingsCircomVerifyConstMeta =>
      const TaskConstMeta(
        debugName: "circom_verify",
        argNames: ["proof", "zkeyPath"],
      );
  ...
  Future<G1> circomProverBindingsG1Default() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsG1DefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsG1DefaultConstMeta =>
  ...
  Future<G2> circomProverBindingsG2Default() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsG2DefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsG2DefaultConstMeta =>
  ...
  Future<CircomProofResult> circomProverBindingsGenerateCircomProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsGenerateCircomProofConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsGenerateCircomProofConstMeta =>
      const TaskConstMeta(
  ...
  Future<Halo2ProofResult> circomProverBindingsGenerateHalo2Proof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsGenerateHalo2ProofConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsGenerateHalo2ProofConstMeta =>
      const TaskConstMeta(
  ...
  Future<Uint8List> circomProverBindingsGenerateNoirProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsGenerateNoirProofConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsGenerateNoirProofConstMeta =>
      const TaskConstMeta(
  ...
  Future<Uint8List> circomProverBindingsGetNoirVerificationKey({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsGetNoirVerificationKeyConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsGetNoirVerificationKeyConstMeta =>
      const TaskConstMeta(
  ...
  Future<Halo2ProofResult> circomProverBindingsHalo2ProofResultDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsHalo2ProofResultDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsHalo2ProofResultDefaultConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> circomProverBindingsInitApp() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsInitAppConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsInitAppConstMeta =>
  ...
  Future<String> circomProverBindingsMoproHelloWorld() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsMoproHelloWorldConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsMoproHelloWorldConstMeta =>
  ...
  Future<String> circomProverBindingsMoproWasmHelloWorld() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsMoproWasmHelloWorldConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsMoproWasmHelloWorldConstMeta =>
  ...
  Future<ProofLib> circomProverBindingsProofLibDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsProofLibDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCircomProverBindingsProofLibDefaultConstMeta =>
  ...
  Future<bool> circomProverBindingsVerifyCircomProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsVerifyCircomProofConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsVerifyCircomProofConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> circomProverBindingsVerifyHalo2Proof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsVerifyHalo2ProofConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsVerifyHalo2ProofConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> circomProverBindingsVerifyNoirProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCircomProverBindingsVerifyNoirProofConstMeta,
  ...
  TaskConstMeta get kCircomProverBindingsVerifyNoirProofConstMeta =>
      const TaskConstMeta(
